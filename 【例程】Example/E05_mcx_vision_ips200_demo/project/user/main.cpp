...
int main(void)
{
    ...
    while (1)
    {
        ips200_show_string(10, 10, "seekfree");
        ips200_show_int(10, 30, -123456);
        ips200_show_float(10, 50, -123.123456);
        ips200_show_int(10, 70, 123456);
        ips200_show_float(10, 90, 123.123456);
